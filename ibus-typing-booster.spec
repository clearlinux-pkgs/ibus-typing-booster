...
Version  : 2.24.10
Release  : 111
URL      : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.24.10/ibus-typing-booster-2.24.10.tar.gz
Source0  : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.24.10/ibus-typing-booster-2.24.10.tar.gz
...
%prep
%setup -q -n ibus-typing-booster-2.24.10
cd %{_builddir}/ibus-typing-booster-2.24.10
pushd ..
cp -a ibus-typing-booster-2.24.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704138046
