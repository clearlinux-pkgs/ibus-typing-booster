...
Version  : 2.27.30
Release  : 152
URL      : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.27.30/ibus-typing-booster-2.27.30.tar.gz
Source0  : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.27.30/ibus-typing-booster-2.27.30.tar.gz
...
%prep
%setup -q -n ibus-typing-booster-2.27.30
cd %{_builddir}/ibus-typing-booster-2.27.30
pushd ..
cp -a ibus-typing-booster-2.27.30 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743690810
