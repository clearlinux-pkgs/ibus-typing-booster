...
Version  : 2.27.33
Release  : 154
URL      : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.27.33/ibus-typing-booster-2.27.33.tar.gz
Source0  : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.27.33/ibus-typing-booster-2.27.33.tar.gz
...
%prep
%setup -q -n ibus-typing-booster-2.27.33
cd %{_builddir}/ibus-typing-booster-2.27.33
pushd ..
cp -a ibus-typing-booster-2.27.33 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744748376
