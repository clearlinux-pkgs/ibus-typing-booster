...
Version  : 2.13.0
Release  : 46
URL      : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.13.0/ibus-typing-booster-2.13.0.tar.gz
Source0  : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.13.0/ibus-typing-booster-2.13.0.tar.gz
...
%prep
%setup -q -n ibus-typing-booster-2.13.0
cd %{_builddir}/ibus-typing-booster-2.13.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1627924992
...
cp %{_builddir}/ibus-typing-booster-2.13.0/COPYING %{buildroot}/usr/share/package-licenses/ibus-typing-booster/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
