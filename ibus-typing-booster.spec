...
Version  : 2.19.12
Release  : 85
URL      : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.19.12/ibus-typing-booster-2.19.12.tar.gz
Source0  : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.19.12/ibus-typing-booster-2.19.12.tar.gz
...
%prep
%setup -q -n ibus-typing-booster-2.19.12
cd %{_builddir}/ibus-typing-booster-2.19.12
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672327392
