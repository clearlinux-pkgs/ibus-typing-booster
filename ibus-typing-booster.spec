...
Source0  : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.24.11/ibus-typing-booster-2.24.11.tar.gz
...
%prep
%setup -q -n ibus-typing-booster-2.24.11
cd %{_builddir}/ibus-typing-booster-2.24.11
pushd ..
cp -a ibus-typing-booster-2.24.11 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704726639
