...
Version  : 2.25.6
Release  : 118
URL      : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.25.6/ibus-typing-booster-2.25.6.tar.gz
Source0  : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.25.6/ibus-typing-booster-2.25.6.tar.gz
...
%prep
%setup -q -n ibus-typing-booster-2.25.6
cd %{_builddir}/ibus-typing-booster-2.25.6
pushd ..
cp -a ibus-typing-booster-2.25.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712769864
