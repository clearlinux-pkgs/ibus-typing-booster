...
Source0  : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.27.64/ibus-typing-booster-2.27.64.tar.gz
...
%prep
%setup -q -n ibus-typing-booster-2.27.64
cd %{_builddir}/ibus-typing-booster-2.27.64
pushd ..
cp -a ibus-typing-booster-2.27.64 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749773416
