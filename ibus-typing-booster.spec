...
Version  : 2.20.0
Release  : 87
URL      : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.20.0/ibus-typing-booster-2.20.0.tar.gz
Source0  : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.20.0/ibus-typing-booster-2.20.0.tar.gz
...
%prep
%setup -q -n ibus-typing-booster-2.20.0
cd %{_builddir}/ibus-typing-booster-2.20.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674163855
