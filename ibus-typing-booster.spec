...
Version  : 2.25.15
Release  : 127
URL      : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.25.15/ibus-typing-booster-2.25.15.tar.gz
Source0  : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.25.15/ibus-typing-booster-2.25.15.tar.gz
...
%prep
%setup -q -n ibus-typing-booster-2.25.15
cd %{_builddir}/ibus-typing-booster-2.25.15
pushd ..
cp -a ibus-typing-booster-2.25.15 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724658099
