...
Source0  : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.19.10/ibus-typing-booster-2.19.10.tar.gz
...
%prep
%setup -q -n ibus-typing-booster-2.19.10
cd %{_builddir}/ibus-typing-booster-2.19.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669814149
