...
Source0  : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.10.2/ibus-typing-booster-2.10.2.tar.gz
...
%prep
%setup -q -n ibus-typing-booster-2.10.2
cd %{_builddir}/ibus-typing-booster-2.10.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608314380
...
cp %{_builddir}/ibus-typing-booster-2.10.2/COPYING %{buildroot}/usr/share/package-licenses/ibus-typing-booster/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
