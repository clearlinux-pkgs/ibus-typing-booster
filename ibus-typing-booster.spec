...
Version  : 2.27.2
Release  : 138
URL      : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.27.2/ibus-typing-booster-2.27.2.tar.gz
Source0  : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.27.2/ibus-typing-booster-2.27.2.tar.gz
...
%prep
%setup -q -n ibus-typing-booster-2.27.2
cd %{_builddir}/ibus-typing-booster-2.27.2
pushd ..
cp -a ibus-typing-booster-2.27.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735145140
