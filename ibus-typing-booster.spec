...
Source0  : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.25.12/ibus-typing-booster-2.25.12.tar.gz
...
%prep
%setup -q -n ibus-typing-booster-2.25.12
cd %{_builddir}/ibus-typing-booster-2.25.12
pushd ..
cp -a ibus-typing-booster-2.25.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720638920
