...
Version  : 2.25.14
Release  : 126
URL      : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.25.14/ibus-typing-booster-2.25.14.tar.gz
Source0  : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.25.14/ibus-typing-booster-2.25.14.tar.gz
...
%prep
%setup -q -n ibus-typing-booster-2.25.14
cd %{_builddir}/ibus-typing-booster-2.25.14
pushd ..
cp -a ibus-typing-booster-2.25.14 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721744963
