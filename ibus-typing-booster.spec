...
Source0  : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.25.16/ibus-typing-booster-2.25.16.tar.gz
...
%prep
%setup -q -n ibus-typing-booster-2.25.16
cd %{_builddir}/ibus-typing-booster-2.25.16
pushd ..
cp -a ibus-typing-booster-2.25.16 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726851813
