...
Source0  : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.25.0/ibus-typing-booster-2.25.0.tar.gz
...
%prep
%setup -q -n ibus-typing-booster-2.25.0
cd %{_builddir}/ibus-typing-booster-2.25.0
pushd ..
cp -a ibus-typing-booster-2.25.0 buildavx2
popd
pushd ..
cp -a ibus-typing-booster-2.25.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707232614
