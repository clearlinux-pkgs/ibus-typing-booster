...
Version  : 2.25.19
Release  : 131
URL      : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.25.19/ibus-typing-booster-2.25.19.tar.gz
Source0  : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.25.19/ibus-typing-booster-2.25.19.tar.gz
...
%prep
%setup -q -n ibus-typing-booster-2.25.19
cd %{_builddir}/ibus-typing-booster-2.25.19
pushd ..
cp -a ibus-typing-booster-2.25.19 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729444657
