...
Source0  : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.24.3/ibus-typing-booster-2.24.3.tar.gz
...
%prep
%setup -q -n ibus-typing-booster-2.24.3
cd %{_builddir}/ibus-typing-booster-2.24.3
pushd ..
cp -a ibus-typing-booster-2.24.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697554778
