...
Source0  : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.27.23/ibus-typing-booster-2.27.23.tar.gz
...
%prep
%setup -q -n ibus-typing-booster-2.27.23
cd %{_builddir}/ibus-typing-booster-2.27.23
pushd ..
cp -a ibus-typing-booster-2.27.23 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738941479
