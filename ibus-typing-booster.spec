...
Version  : 2.11.5
Release  : 43
URL      : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.11.5/ibus-typing-booster-2.11.5.tar.gz
Source0  : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.11.5/ibus-typing-booster-2.11.5.tar.gz
...
%prep
%setup -q -n ibus-typing-booster-2.11.5
cd %{_builddir}/ibus-typing-booster-2.11.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624373183
...
cp %{_builddir}/ibus-typing-booster-2.11.5/COPYING %{buildroot}/usr/share/package-licenses/ibus-typing-booster/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
