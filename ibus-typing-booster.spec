...
Source0  : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.23.1/ibus-typing-booster-2.23.1.tar.gz
...
%prep
%setup -q -n ibus-typing-booster-2.23.1
cd %{_builddir}/ibus-typing-booster-2.23.1
pushd ..
cp -a ibus-typing-booster-2.23.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1688568029
