...
Source0  : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.21.1/ibus-typing-booster-2.21.1.tar.gz
...
%prep
%setup -q -n ibus-typing-booster-2.21.1
cd %{_builddir}/ibus-typing-booster-2.21.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675964793
