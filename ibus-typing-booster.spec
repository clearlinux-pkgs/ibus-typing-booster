...
Version  : 2.27.56
Release  : 164
URL      : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.27.56/ibus-typing-booster-2.27.56.tar.gz
Source0  : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.27.56/ibus-typing-booster-2.27.56.tar.gz
...
%prep
%setup -q -n ibus-typing-booster-2.27.56
cd %{_builddir}/ibus-typing-booster-2.27.56
pushd ..
cp -a ibus-typing-booster-2.27.56 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747674145
