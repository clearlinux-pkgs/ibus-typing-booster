...
Version  : 2.27.63
Release  : 166
URL      : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.27.63/ibus-typing-booster-2.27.63.tar.gz
Source0  : https://github.com/mike-fabian/ibus-typing-booster/releases/download/2.27.63/ibus-typing-booster-2.27.63.tar.gz
...
%prep
%setup -q -n ibus-typing-booster-2.27.63
cd %{_builddir}/ibus-typing-booster-2.27.63
pushd ..
cp -a ibus-typing-booster-2.27.63 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748960316
